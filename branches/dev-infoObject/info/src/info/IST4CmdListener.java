 ...
 * The specification of a the interface to a command listener, which can connect to a
...
interface IST4CmdListener<TContext,TCmdResult>
{
    /** The listener gets the command as a String and responds to it by an object of agreed
        ...
        generating any text ouput, then the listener should return null.
          @param context
        This is the obeject of agreed type, which had been passed to the command
        interpreter at its creation time. Any time the interpreter invokes this listener,
        it'll pass this object for reference. This way a listener can connect to different
